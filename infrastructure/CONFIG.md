...
Converts YearData object to plain dict with 7 fields.
...
### scenarios.json
Located at project root. Flat scenario definitions.

### scenario_nodes.json
Located at `scenario_analysis/scenario_nodes.json` (unchanged). Tree nodes.

### analysis.json
Located at `scenario_analysis/analysis.json` (unchanged). Analysis definitions.
