...
- Change default investment return rate
- Set initial portfolio balance

### `settings.json` — Simulation Configuration
```json
{
  "simulation": {
    "years": 20
...
4. Adjust parameters (income, expenses, mortgage, etc.)
